...
<body class="BackgroundBody">
   ...
   // Get selected genre from URL
    ...
    $sql = "
        ...
        JOIN story s ON ss.storyID = s.StoryID
        JOIN users u ON s.userID = u.userID   -- author of the story
    ...
    <div class="d-flex row-3 mediumTop flex-wrap">
             ...
             alt="Profile image" class="profileImg">
                ...
                <h1 class="lato-bold WhiteTextBig MarginLeftBig">Saved stories</h1>
            </div>
            ...
            <div>
                <div class="col">
                    ...
                    <button class="giftBtn d-flex row-2 tertiaryButton"
                            ...
                            data-user="<?php echo $row['authorID']; ?>">
